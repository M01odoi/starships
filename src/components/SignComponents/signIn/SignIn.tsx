...
import FormBuilder from "../signUp/FormBuilder";
import {loginFormConfig} from "../signUp/fields";
        ...
        <div className="sign-up-page sign-in-page">
            <section className="sign-up-window shadow">
                <div className="sign-up-image">
                    <FontAwesomeIcon icon="user-alt" className="fa-3x sign-up-image-icon shadow"/>
                </div>
                <h1> Member Login</h1>
                <FormBuilder onSubmit={onSubmit} fields={loginFormConfig} nameOfButton="Login"/>
                <p onClick={() => navigate(signup)} className="sign-up-hint">Create account</p>
                {/*<p onClick={()=>navigate(peopleAndStarshipsCards)} className="sign-up-hint">ENTER</p>*/}
            </section>
        </div>
    )
}
